...
/*--------------------------------------------------------------------------------------------------------------*/
	    ...
	    $wp_customize->add_control( new parallaxsome_Info_Control(
	        ...
	        'tpl_color_upgrade_info',
		        array(
		            'section' => 'colors',
		            'description' => __('Want to add have template color option for the site, <a target="__blank" href="https://themeforest.net/item/parallaxsome-pro-multipurpose-wordpress-theme/20033554">Upgrade to</a> the Parallaxsome Pro', 'parallaxsome')
		        )
		    )
	    );
