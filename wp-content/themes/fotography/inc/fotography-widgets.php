 ...
 *
 * @since FotoGraphy Widget Pack 1.0
 */
 ...
 * @since FotoGraphy Widget Pack 1.0
 */
require get_template_directory() . '/inc/widgets/fotography-widget.php';
 ...
 * @since FotoGraphy Widget Pack 1.0
 */
require get_template_directory() . '/inc/widgets/widget-callto-action.php';
