...
== Description ==
[Homepage](https://accesspressthemes.com/) | [Documentation](https://accesspressthemes.com/documentation/documentation-plugin-instruction-accesspress-pinterest) | [Support](https://accesspressthemes.com/support) | [Demo](http://demo.accesspressthemes.com/wordpress-plugins/accesspress-pinterest/) | [Premium Version](https://accesspressthemes.com/wordpress-plugins/accesspress-pinterest-pro/)
...
== Changelog ==
= 3.2.0 =
* Done the addition of the index file for security of the directory listing.

= 3.1.9 =
* Done the testing of the plugin compactibility with wordpress version 4.8
* Done the addition of the font awesome icons locally.

= 3.1.8 =
* Removed unnecesary commented codes from the plugin's backend settings pages.

= 3.1.7 =
* Addition of the filter options(posts, pages, archives, etc) in plugin's backend settings to display the pintererst pinit button.

= 3.1.6 =
* The addition of the no follow attribute to the latest pin widget's Pinterest image links.

= 3.1.5 =
* Addition of the examples in how to use section for no pin usage for image src.

= 3.1.4 =
* Done the compactibility test with wordpress version 4.7
* Removed the color options for the pinterest save button for rectangle shape.

= 3.1.3 =
* Done the link fixing for the social networks in the about section. 

= 3.1.2 =
* Made the plugin ready for language translation for the language selection option of the plugin's backend settings. 

= 3.1.1 =
* Addition of the Documentation link in how to use section.

= 3.1.0 =
* Addition of More WordPress Resources link.

= 3.0.9 =
* Addition of more languages provided by pinterest for pin it or save button.

= 3.0.8 =
* Addition of the security check to prevent the direct access of plugin's directories.

= 3.0.7 =
* Bug fixing for the board widget.

= 3.0.6 =
* Done the addition of save button shortcodes. Please see "how to use" section for more details.

= 3.0.5 =
* Updated the Isotope js to latest version.
